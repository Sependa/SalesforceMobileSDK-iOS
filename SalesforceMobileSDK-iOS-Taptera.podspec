Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/Taptera/SalesforceMobileSDK-iOS.git",
                     :commit => "933cadefebd0d0040b423fc8d0e0e3e802a176e2",
                     :submodules => true }
  ...
  s.subspec 'SalesforceCommonUtils' do |commonutils|
      ...
      commonutils.header_dir = 'SalesforceCommonUtils'
  ...
  s.subspec 'SalesforceSDKCommon' do |salesforcesdkcommon|
      ...
      salesforcesdkcommon.header_dir = 'SalesforceSDKCommon'
  ...
  s.subspec 'SalesforceSecurity' do |salesforcesecurity|
      ...
      salesforcesecurity.dependency 'SalesforceMobileSDK-iOS-Taptera/SalesforceCommonUtils'
      salesforcesecurity.dependency 'SalesforceMobileSDK-iOS-Taptera/SalesforceSDKCommon'
      ...
      salesforcesecurity.header_dir = 'SalesforceSecurity'
  ...
  s.subspec 'SalesforceOAuth' do |oauth|
      ...
      oauth.dependency 'SalesforceMobileSDK-iOS-Taptera/SalesforceCommonUtils'
      oauth.dependency 'SalesforceMobileSDK-iOS-Taptera/SalesforceSDKCommon'
      oauth.dependency 'SalesforceMobileSDK-iOS-Taptera/SalesforceSecurity'
      ...
      oauth.header_dir = 'SalesforceOAuth'
  ...
  s.subspec 'SalesforceSDKCore' do |sdkcore|
      ...
      sdkcore.dependency 'SalesforceMobileSDK-iOS-Taptera/SalesforceCommonUtils'
      sdkcore.dependency 'SalesforceMobileSDK-iOS-Taptera/SalesforceSDKCommon'
      sdkcore.dependency 'SalesforceMobileSDK-iOS-Taptera/SalesforceSecurity'
      sdkcore.dependency 'SalesforceMobileSDK-iOS-Taptera/SalesforceOAuth'
  ...
  s.subspec 'SalesforceNetwork' do |networksdk|
      ...
      networksdk.dependency 'SalesforceMobileSDK-iOS-Taptera/SalesforceSDKCore'
      networksdk.dependency 'SalesforceMobileSDK-iOS-Taptera/SalesforceOAuth'
      networksdk.dependency 'SalesforceMobileSDK-iOS-Taptera/SalesforceSecurity'
      networksdk.dependency 'SalesforceMobileSDK-iOS-Taptera/SalesforceCommonUtils'
      networksdk.dependency 'SalesforceMobileSDK-iOS-Taptera/SalesforceSDKCommon'
      ...
      networksdk.header_dir = 'SalesforceNetwork'
  ...
  s.subspec 'SalesforceRestAPI' do |restapi|
      ...
      restapi.dependency 'SalesforceMobileSDK-iOS-Taptera/SalesforceNetwork'
      restapi.dependency 'SalesforceMobileSDK-iOS-Taptera/SalesforceSDKCore'
      restapi.dependency 'SalesforceMobileSDK-iOS-Taptera/SalesforceOAuth'
      restapi.dependency 'SalesforceMobileSDK-iOS-Taptera/SalesforceSecurity'
      restapi.dependency 'SalesforceMobileSDK-iOS-Taptera/SalesforceSDKCore'
      restapi.dependency 'SalesforceMobileSDK-iOS-Taptera/SalesforceCommonUtils'
      restapi.dependency 'SalesforceMobileSDK-iOS-Taptera/SalesforceSDKCommon'
      ...
      restapi.header_dir = 'SalesforceRestAPI'
  ...
  s.subspec 'SmartSync' do |smartsync|
      ...
      smartsync.dependency 'SalesforceMobileSDK-iOS-Taptera/SalesforceRestAPI'
      smartsync.dependency 'SalesforceMobileSDK-iOS-Taptera/SalesforceNetwork'
      smartsync.dependency 'SalesforceMobileSDK-iOS-Taptera/SalesforceSDKCore'
      smartsync.dependency 'SalesforceMobileSDK-iOS-Taptera/SalesforceOAuth'
      smartsync.dependency 'SalesforceMobileSDK-iOS-Taptera/SalesforceSecurity'
      smartsync.dependency 'SalesforceMobileSDK-iOS-Taptera/SalesforceSDKCore'
      smartsync.dependency 'SalesforceMobileSDK-iOS-Taptera/SalesforceCommonUtils'
      smartsync.dependency 'SalesforceMobileSDK-iOS-Taptera/SalesforceSDKCommon'
      ...
      smartsync.header_dir = 'SmartSync'
